...
public class Runner {
	public static void main(String[] args) {
		...
		CollectionCleaner collectionCleaner = new CollectionCleaner(numbers,
				monitor);
		ElementCreator elementCreator = new ElementCreator(numbers, monitor);

		Thread t1 = new Thread(elementRemover);
		Thread t2 = new Thread(collectionCleaner);
		Thread t3 = new Thread(elementCreator);
